        ...
        <div className="max-w-lg w-full bg-white shadow-lg rounded-lg p-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center">
              ...
              <span className="ml-2 text-gray-700">{user.phoneNumber}</span>
            </div>
            <div className="flex items-center">
              ...
              <span className="ml-2 text-gray-700">
                {new Date(
                  convertArrayToDate(user.dateOfBirth)
                ).toLocaleDateString()}
              </span>
            </div>
            <div className="flex items-center">
              ...
              <span className="ml-2 text-gray-700">{user.gender}</span>
            </div>
            <div className="flex items-center">
              <FaCalendarPlus className="text-blue-500 mr-3" />
              <span className="font-semibold">Account Created At:</span>
              <span className="ml-2 text-gray-700">
                {new Date(
                  convertArrayToDate(user.createdAt)
                ).toLocaleDateString()}
              </span>
            </div>
            <div className="flex items-center">
              ...
              <span className="ml-2 text-gray-700">
                {new Date(
                  convertArrayToDate(user.updatedAt)
                ).toLocaleDateString()}
              </span>
            </div>
          </div>
